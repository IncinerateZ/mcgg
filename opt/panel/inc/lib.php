...
");
	...
	} else if ($_POST['version'] == '1.13.2') {
		copy('serverbase/spigot-1.13.2.jar',$_POST['dir'].'/spigot-1.13.2.jar');
	} else if ($_POST['version'] == '1.14.2') {
		copy('serverbase/spigot-1.14.2.jar',$_POST['dir'].'/spigot-1.14.2.jar');
